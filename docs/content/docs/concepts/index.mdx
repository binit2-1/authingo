---
title: Concepts
description: The core ideas behind AuthInGo sessions, cookies, storage, and route protection.
---
...
<Callout title="Local development" type="warn">
  Secure cookies require HTTPS in browsers. For local HTTP-only development, you may need a local TLS proxy or a development-only cookie configuration once the core exposes that option.
</Callout>
